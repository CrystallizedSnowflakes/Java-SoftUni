...
/**
 * 1) Клас (EntityManagerFactory), в което да регистрираме настройките за връзка с базата данни
 * - вид база, потребителско име
 и парола, както и името на базата данни. Този клас в ответ ще върне обект, който ще може да управлява
 ...
 * 2) Преди да се върне такъв обект, искаме да обиколим всички класове в проекта и да намерим тези, които са
 ...
 и @Column(име, тип)
   ...
   4) Класът, който ще се върне от т.1. (EntityManager) ще има операции за извличане на обект по ИД
...
//        User pesho = entityManager.findById(3, User.class); // pesho: User@3005
