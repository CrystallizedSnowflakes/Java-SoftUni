...
public class Mid01_19Dec_DisneylandJourney {
    public static void main(String[] args) {
        ...
        if (savings >= costsOfTheJourney){
            System.out.printf("Bravo! You can go to Disneyland and you will have %.2flv. for souvenirs.", savings - costsOfTheJourney);
        }else{
