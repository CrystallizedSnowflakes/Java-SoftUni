...
public class A06Students3 {
    public static void main(String[] args) {
        ...
        while (!line.equals("end")) {
            ...
            Student existingStudent = getStudent(students, s.firstName, s.lastName);

            if (existingStudent != null){
                existingStudent.setAge(s.age);
                existingStudent.setHometown(s.hometown);
            }else{
    ...
    static Student getStudent1(List<Student> students, String firstName, String lastName) {
        for (Student student : students){
            if(student.getFirstName().equals(firstName)
                    && student.getLastName().equals(lastName))
                return student;
