...
public class ME01CompanyRoster {
    ...
    public static void main(String[] args) {
        ...
        List<String> uniqueDepartments = employees.stream().map(Employee::getDepartment).distinct().collect(Collectors.toList());
    ...
    public static class Employee{
        ...
        public static Employee parseEmployee(String line) {
            ...
            Employee employee = new Employee(employeeParameters[0],
                    Double.parseDouble(employeeParameters[1]), employeeParameters[2],
