...
public class Clinic {
    private List<Pet> data; // a collection which stores the pets
    private int capacity;

    // constrictor should receive capacity, also it should initialize the data
    ...
    public boolean remove(String name){
        ...
        /*for (Pet pet : this.data) {
            if (pet.getName().equals(name)){
                return this.data.remove(pet); // true
            }
        }
        return false;*/
    }
