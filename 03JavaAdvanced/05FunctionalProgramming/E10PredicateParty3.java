...
public class E10PredicateParty3 {
    public static void main(String[] args) {
        ...
        while (!input.equals("Party!")){
            ...
            BiFunction<List<String>,String, List<String>> filterByCriteria = (list, commands) -> {
            ...
            List<String> filteredByCriteria = filterByCriteria.apply(names, command);
