    ...
    public void addDriver(Driver driver) {
        ...
        if (this.drivers.contains(driver)){
            ...
            throw new IllegalArgumentException(String.format(
                    ExceptionMessages.DRIVER_ALREADY_ADDED, driver.getName(), this.getClass().getSimpleName())); //this.name()
        }
/*        String name = driver.getName();
        if (drivers.stream().anyMatch(d->d.getName().equals(name))){
            throw new IllegalArgumentException(String.format(ExceptionMessages.DRIVER_ALREADY_ADDED, name, getName()));
        }*/
