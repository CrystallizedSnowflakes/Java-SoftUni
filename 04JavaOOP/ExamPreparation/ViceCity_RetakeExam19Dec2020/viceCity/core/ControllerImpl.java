...
public class ControllerImpl implements Controller {
    ...
    public String fight() {
        ...
        List<Player> deathPlayers = players.values().stream()
                .filter(p -> !p.isAlive())
        ...
        sb.append(System.lineSeparator());
        sb.append(String.format(MAIN_PLAYER_KILLED_CIVIL_PLAYERS_MESSAGE, deathPlayers.size()));
        sb.append(System.lineSeparator());
        sb.append(String.format(CIVIL_PLAYERS_LEFT_MESSAGE, players.size() - deathPlayers.size()));

        for (Player deathPlayer : deathPlayers) {
            players.remove(deathPlayer.getName());
        }
